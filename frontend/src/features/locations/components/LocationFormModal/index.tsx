      ...
      >
        <FormGrid>
          <Form.Item
            ...
            name="code"
            rules={[{ required: true, message: 'Informe o código do local.' }]}
          >
          ...
          <Form.Item
            label="Nome do local *"
            name="name"
            rules={[{ required: true, message: 'Informe o nome do local.' }]}
          >
            <Input placeholder="Ex: Laboratório de Informática" />
          </Form.Item>
          ...
          <FullField>
            <Form.Item label="Descrição" name="description">
              <Input.TextArea placeholder="Descrição ou observações sobre o local..." />
            </Form.Item>
          </FullField>
        </FormGrid>
      </Form>
